...
<title>Phototype | Production Solutions | Print Services | 3D Rendering</title>
					...
					<section id="main-content">
                        <div class="row">
                            <div class="small-12 large-12 columns">
                                ...
                                <h2>It's not just what we do, it's how we do it, and it's personal.<img src="../images/general/oxiclean-thin.png" alt="Oxiclean" class="top-right" /></h2>   
                                <p>
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                                </p>
                                
                                <h3 class="large-text">Lorem Ipsum is simply<img src="../images/general/3D-employee.png" alt="Employee" class="img-radius lower-left-image full-width"/></h3>
                                ...
                                <p>
                                    <h3><img src="../images/general/huggies.png" alt="Huggies" class="bottom-left" />It's not just what we do, it's how we do it, and it's personal.</h3>  
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                                </p>
                                <p>
                                    <h3>Lorem Ipsum is simply dummy text of the printing</h3>  
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                                    <img src="../images/general/klenex.png" alt="Klenex" class="bottom" />
                                </p>
                                <!-- CMSContentEnd:Main -->
                            </div>
                        </div>
