			...
			<div class="row">
				<div class="small-12 columns">
					<section id="main-content">
                        <div class="row">
                            <div class="left small-12 large-8 columns">
                                
                                <!-- CMSContentStart:TopContent -->
                                <h2>Prototype...</h2>
                                ...
                                <!-- CMSContentEnd:TopContent -->
                                
                            </div>
                            <div class="right small-12 large-4 columns">
                                
                                <!-- CMSContentStart:TopRightImage -->
                        ...
                        <div class="row">
                            <div class="small-12 columns">-->
                                ...
                                <p>
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make uor propierty <a href="#">Smart Art<sup>sm</sup></a> Process.
                                </p>
                                <!-- CMSContentEnd:MiddleContent -->
                        ...
                        <div class="row">
                            <div class="small-12 columns">
                                <div class="left">
                                    ...
                                    <!-- CMSContentStart:LowerLeftImage -->
                                    <img src="/images/general/welcome-men.png" alt="Welcome men" class="img-radius welcome-men" width="225px" height="auto"/>
                                    <!-- CMSContentEnd:LowerLeftImage -->
                                    
                                </div>
								<div><!-- this div added to wrap CMS area to prevent siblings from being effected from highlight css-->
                                <!-- CMSContentStart:LowerRightContent -->
                                ...
                                <!-- CMSContentEnd:LowerRightContent -->
                                </div><!--end wrapping CMS div-->
                            </div>
                        </div>
                         <div class="row">
                            <div class="small-12 columns">
                                
                                <!-- CMSContentStart:BottomContent -->
